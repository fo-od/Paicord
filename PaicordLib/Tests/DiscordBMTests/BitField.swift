...
class BitFieldTests: XCTestCase {
  ...
  let allCases: [Raw] = [
    ...
    .addReactions,
    .viewAuditLog, .prioritySpeaker, .stream, .viewChannel, .sendMessages, .sendTtsMessages,
    .manageMessages,
    ...
    .manageNicknames,
    .manageRoles, .manageWebhooks, .manageGuildExpressions, .useApplicationCommands,
    .requestToSpeak, .manageEvents,
    .manageThreads, .createPublicThreads, .createPrivateThreads, .useExternalStickers,
  ...
  func testInitFromBitValue() {
    ...
    do {
      ...
      let field2 = IntBitField<Raw>([
        .administrator, .viewAuditLog, .kickMembers, .sendMessagesInThreads, .banMembers,
        .manageGuild,
        .manageChannels, .muteMembers, .manageMessages, .manageThreads, .sendMessages,
        .sendTtsMessages,
        .useExternalStickers, .manageWebhooks, .deafenMembers, .moderateMembers, .useExternalEmojis,
        .viewChannel, .prioritySpeaker, .createPrivateThreads, .useApplicationCommands,
        .createInstantInvite,
