...
public struct AutoModerationRule: Sendable, Codable {
  ...
  public enum Action: Sendable, Codable, ValidatablePayload {
    ...
    public func encode(to encoder: any Encoder) throws {
      ...
      case .sendAlertMessage(let channelId):
...
/// https://docs.discord.food/topics/gateway-events#auto-moderation-mention-raid-detection
public struct AutoModerationMentionRaidDetection: Sendable, Codable {
  public var guild_id: GuildSnowflake
  public var decision_id: String
  public var suspicious_mention_activity_until: DiscordTimestamp
}
