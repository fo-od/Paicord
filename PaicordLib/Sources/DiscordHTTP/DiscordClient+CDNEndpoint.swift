...
extension DiscordClient {
  ...
  @inlinable
  public func getCDNCustomEmoji(emojiId: EmojiSnowflake) async throws
    -> DiscordCDNResponse
  {
  ...
  public func getCDNGuildDiscoverySplash(
    ...
    let endpoint = CDNEndpoint.guildDiscoverySplash(
      guildId: guildId,
      splash: splash
    )
    return try await self.send(
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNGuildBanner(guildId: GuildSnowflake, banner: String)
    async throws -> DiscordCDNResponse
  {
    let endpoint = CDNEndpoint.guildBanner(guildId: guildId, banner: banner)
    return try await self.send(
      request: .init(to: endpoint),
      fallbackFileName: banner
    )
  }
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNUserBanner(userId: UserSnowflake, banner: String)
    async throws -> DiscordCDNResponse
  {
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNUserAvatar(userId: UserSnowflake, avatar: String)
    async throws -> DiscordCDNResponse
  {
  ...
  public func getCDNUserAvatarDecoration(
    ...
    return try await self.send(
      request: .init(to: endpoint),
      fallbackFileName: avatarDecoration
    )
  }
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNApplicationIcon(appId: ApplicationSnowflake, icon: String)
    async throws -> DiscordCDNResponse
  {
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNApplicationCover(appId: ApplicationSnowflake, cover: String)
    async throws -> DiscordCDNResponse
  {
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNTeamIcon(teamId: TeamSnowflake, icon: String) async throws
    -> DiscordCDNResponse
  {
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNSticker(
    stickerId: StickerSnowflake,
    format: Sticker.FormatKind
  ) async throws -> DiscordCDNResponse {
    let endpoint = CDNEndpoint.sticker(stickerId: stickerId, format: format)
    return try await self.send(
      request: .init(to: endpoint),
  ...
  /// https://discord.com/developers/docs/reference#image-formatting-cdn-endpoints
  @inlinable
  public func getCDNRoleIcon(roleId: RoleSnowflake, icon: String) async throws
    -> DiscordCDNResponse
  {
  ...
  public func getCDNGuildScheduledEventCover(
    ...
    let endpoint = CDNEndpoint.guildScheduledEventCover(
      eventId: eventId,
      cover: cover
    )
    return try await self.send(
