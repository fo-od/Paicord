...
extension DiscordClient {
  ...
  public func getAutoModerationRule(
    ...
    let endpoint = APIEndpoint.getAutoModerationRule(
      guildId: guildId,
      ruleId: ruleId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  public func updateAutoModerationRule(
    ...
    let endpoint = APIEndpoint.updateAutoModerationRule(
      guildId: guildId,
      ruleId: ruleId
    )
    return try await self.send(
  ...
  public func deleteAutoModerationRule(
    ...
    let endpoint = APIEndpoint.deleteAutoModerationRule(
      guildId: guildId,
      ruleId: ruleId
    )
    return try await self.send(
  ...
  public func crosspostMessage(
    ...
    let endpoint = APIEndpoint.crosspostMessage(
      channelId: channelId,
      messageId: messageId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  public func updateMessage(
    ...
    let endpoint = APIEndpoint.updateMessage(
      channelId: channelId,
      messageId: messageId
    )
    return try await self.sendMultipart(
  ...
  public func deleteMessage(
    ...
    let endpoint = APIEndpoint.deleteMessage(
      channelId: channelId,
      messageId: messageId
    )
    return try await self.send(
  ...
  public func pinMessage(
    ...
    let endpoint = APIEndpoint.pinMessage(
      channelId: channelId,
      messageId: messageId
    )
    return try await self.send(
  ...
  public func unpinMessage(
    ...
    let endpoint = APIEndpoint.unpinMessage(
      channelId: channelId,
      messageId: messageId
    )
    return try await self.send(
  ...
  /// https://docs.discord.food/resources/channel#add-channel-recipient
  @inlinable
  public func addGroupDmUser(
    ...
    let endpoint = APIEndpoint.addGroupDmUser(
      channelId: channelId,
      userId: userId
    )
    return try await self.send(
  ...
  /// https://docs.discord.food/resources/channel#remove-channel-recipient
  @inlinable
  public func deleteGroupDmUser(
    channelId: ChannelSnowflake,
    userId: UserSnowflake
  ) async throws -> DiscordHTTPResponse {
    let endpoint = APIEndpoint.deleteGroupDmUser(
      channelId: channelId,
      userId: userId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  public func createThreadFromMessage(
    ...
    let endpoint = APIEndpoint.createThreadFromMessage(
      channelId: channelId,
      messageId: messageId
    )
    return try await self.send(
  ...
  @available(
    *,
    deprecated,
    renamed: "startThreadInForumOrMediaChannel(channelId:reason:payload:)"
  )
  @inlinable
  ...
  @inlinable
  public func joinThread(id: ChannelSnowflake) async throws
    -> DiscordHTTPResponse
  {
  ...
  public func addThreadMember(
    ...
    let endpoint = APIEndpoint.addThreadMember(
      channelId: threadId,
      userId: userId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  @inlinable
  public func leaveThread(id: ChannelSnowflake) async throws
    -> DiscordHTTPResponse
  {
  ...
  public func deleteThreadMember(
    ...
    let endpoint = APIEndpoint.deleteThreadMember(
      channelId: threadId,
      userId: userId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  public func getThreadMember(
    ...
    let endpoint = APIEndpoint.getThreadMember(
      channelId: threadId,
      userId: userId
    )
    try assertBotOnly(endpoint: endpoint)
    return try await self.send(request: .init(to: endpoint))
  }
  ...
  public func listOwnPrivateArchivedThreads(
    ...
    let endpoint = APIEndpoint.listOwnPrivateArchivedThreads(
      channelId: channelId
    )
    return try await self.send(
      request: .init(
  ...
  public func updateGuildEmoji(
    ...
    let endpoint = APIEndpoint.updateGuildEmoji(
      guildId: guildId,
      emojiId: emojiId
    )
    return try await self.send(
  ...
  public func deleteGuildEmoji(
    ...
    let endpoint = APIEndpoint.deleteGuildEmoji(
      guildId: guildId,
      emojiId: emojiId
    )
    return try await self.send(
  ...
  public func listEntitlements(
    ...
    let endpoint = APIEndpoint.listEntitlements(
      applicationId: try requireAppId(appId)
    )
    return try await self.send(
      request: .init(
  ...
  public func createTestEntitlement(
    ...
    let endpoint = APIEndpoint.createTestEntitlement(
      applicationId: try requireAppId(appId)
    )
    return try await self.send(
      request: .init(to: endpoint),
  ...
  /// https://docs.discord.food/resources/guild#create-guild
  @inlinable
  ...
  @inlinable
  public func deleteGuild(id: GuildSnowflake) async throws
    -> DiscordHTTPResponse
  {
  ...
  public func updateGuildMember(
    ...
    let endpoint = APIEndpoint.updateGuildMember(
      guildId: guildId,
      userId: userId
    )
    return try await self.send(
  ...
  public func deleteGuildMember(
    ...
    let endpoint = APIEndpoint.deleteGuildMember(
      guildId: guildId,
      userId: userId
    )
    return try await self.send(
  ...
  public func banUserFromGuild(
    ...
    let endpoint = APIEndpoint.banUserFromGuild(
      guildId: guildId,
      userId: userId
    )
    return try await self.send(
  ...
  public func unbanUserFromGuild(
    ...
    let endpoint = APIEndpoint.unbanUserFromGuild(
      guildId: guildId,
      userId: userId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  @inlinable
  public func listGuildRoles(id: GuildSnowflake) async throws
    -> DiscordClientResponse<[Role]>
  {
    ...
    return try await self.send(
      request: .init(
        ...
        queries: [
          ...
          (
            "include_roles",
            includeRoles.map { $0.map(\.rawValue).joined(separator: ",") }
          ),
        ]
      )
    )
  ...
  public func getGuildWidgetPng(
    ...
    return try await self.send(
      ...
      fallbackFileName:
        "widget_\((style ?? .default).rawValue)_\(guildId.rawValue)"
    )
  }
  ...
  public func updateVoiceState(
    ...
    let endpoint = APIEndpoint.updateVoiceState(
      guildId: guildId,
      userId: userId
    )
    return try await self.send(
  ...
  @inlinable
  public func getBotGateway() async throws -> DiscordClientResponse<
    Gateway.BotConnectionInfo
  > {
  ...
  @inlinable
  public func getGuildTemplate(code: String) async throws
    -> DiscordClientResponse<GuildTemplate>
  {
      ...
      request: .init(
        ...
        queries: [
          ...
          (
            ...
            guildScheduledEventId.map { "\($0.rawValue)" }
          ),
        ]
      )
    )
  ...
  @inlinable
  public func getOwnOauth2Application() async throws -> DiscordClientResponse<
    DiscordApplication
  > {
  ...
  @inlinable
  public func getSticker(id: StickerSnowflake) async throws
    -> DiscordClientResponse<Sticker>
  {
  ...
  public func getGuildSticker(
    ...
    let endpoint = APIEndpoint.getGuildSticker(
      guildId: guildId,
      stickerId: stickerId
    )
    return try await self.send(request: .init(to: endpoint))
  ...
  public func updateGuildSticker(
    ...
    let endpoint = APIEndpoint.updateGuildSticker(
      guildId: guildId,
      stickerId: stickerId
    )
    return try await self.send(
  ...
  public func deleteGuildSticker(
    ...
    let endpoint = APIEndpoint.deleteGuildSticker(
      guildId: guildId,
      stickerId: stickerId
    )
    return try await self.send(
  ...
  @inlinable
  public func getUser(id: UserSnowflake) async throws -> DiscordClientResponse<
    DiscordUser
  > {
  ...
  @inlinable
  public func listOwnConnections() async throws -> DiscordClientResponse<
  ...
  @inlinable
  public func listVoiceRegions() async throws -> DiscordClientResponse<
    [VoiceRegion]
  > {
  ...
  @inlinable
  public func listChannelWebhooks(channelId: ChannelSnowflake) async throws
    -> DiscordClientResponse<[Webhook]>
  {
  ...
  @inlinable
  public func getGuildWebhooks(guildId: GuildSnowflake) async throws
    -> DiscordClientResponse<[Webhook]>
  {
  ...
  @inlinable
  public func getWebhook(id: WebhookSnowflake) async throws
    -> DiscordClientResponse<Webhook>
  {
  ...
  @inlinable
  public func getWebhook(address: WebhookAddress) async throws
    -> DiscordClientResponse<Webhook>
  {
...
extension DiscordClient {
  ...
  @available(
    *,
    deprecated,
    message: "App id must be optional otherwise there is no point"
  )
  @usableFromInline
  func requireAppId(_ appId: ApplicationSnowflake) throws
  ...
  func assertBotOnly(
    ...
    guard self.authentication.userMode == false else {
      throw DiscordHTTPError.assertionFailureBotOnlyEndpoint(endpoint: endpoint)
    }
  }
  ...
  func assertUserOnly(
    ...
    guard self.authentication.userMode == false else {
      throw DiscordHTTPError.assertionFailureUserOnlyEndpoint(
        endpoint: endpoint
      )
    }
  }
