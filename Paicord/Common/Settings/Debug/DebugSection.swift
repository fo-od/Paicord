...
private let flex: [SettingsPage] = [
  .init(title: "Show Flex", icon: .system("scope"), section: "Debug", action: {
...
extension SettingsPages {
  static let DebugSection: [SettingsPage] = [
    .init(title: "Console", icon: .system("text.page"), section: "Debug") {
